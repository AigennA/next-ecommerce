  ...
  return (
    <div className="container mx-auto p-8 bg-gray-50 rounded-lg shadow-lg mt-10">
      ...
      <p className="text-lg mb-6 text-gray-800 leading-relaxed">
        At <span className="font-semibold text-blue-900">Lammazon</span>, we value your privacy and are committed to protecting your personal information. This Privacy Policy outlines how we collect, use, and safeguard your information when you visit our website or use our services.
      </p>
